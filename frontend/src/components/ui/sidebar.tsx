...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<'li'>) {
    return <li data-slot="sidebar-menu-item" data-sidebar="menu-item" className={cn('group/menu-item relative h-10 px-1.5', className)} {...props} />;
}
...
function SidebarMenuButton({
    ...
    const button = (
        <Comp
            ...
            className={cn(sidebarMenuButtonVariants({ variant, size }), 'h-full', className)}
            {...props}
        />
    );
