...
import type { CreateIssue, GetIssuesParams, Issue, IssueType, UpdateIssue, UpdateIssueType } from '../types/issue';
...
export const updateIssueType = (id: string, payload: UpdateIssueType): Promise<Issue> => apiPatch<Issue>(`/issues/${id}/issue-type`, payload);
